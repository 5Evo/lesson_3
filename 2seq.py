...
list_of_user = ''
str_of_user = input('Введите элементы списка через запятую: ')
list_of_user = str_of_user.replace(',', ' ').replace('/', ' ').replace(';', ' ')
list_of_user.split()

set_of_user = set(list_of_user.split())
print(f'Результат: {set_of_user}')